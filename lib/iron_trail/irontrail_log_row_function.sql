...
BEGIN
    ...
    IF (TG_OP = 'INSERT') THEN
        INSERT INTO "irontrail_changes" ("actor_id", "actor_type",
          "record_table", "operation", "record_id", "new_record", "metadata", "change_created_at")
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
        IF (OLD <> NEW) THEN
          ...
          INSERT INTO "irontrail_changes" ("actor_id", "actor_type", "record_table", "operation",
            "record_id", "old_record", "new_record", "changes", "metadata", "change_created_at")
    ...
    ELSIF (TG_OP = 'DELETE') THEN
        INSERT INTO "irontrail_changes" ("actor_id", "actor_type", "record_table", "operation",
          "record_id", "old_record", "metadata", "change_created_at")
